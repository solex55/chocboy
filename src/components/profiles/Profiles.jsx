...
function Profiles() {
  return (
    <div className="flex max-w-[1300px] mx-auto px-5 md:px-20">
      <div className="w-1/4 mx-auto p-4">
        <div className="w-full">
          <img
            src={smiley}
            alt=""
            className="rounded-full shawdow-lg max-w-full sm:h-64 object-contain"
          />
        </div>
              ...
              <div className=" flex flex-col">
                <div className=" flex flex-col justify-center">
                  <Form className="max-w-[800px] w-full mx-auto p-4">
                    <h3 className="text-4xl font-bold text-main pb-4">
                    ...
                    <button
                      ...
                      className="w-full sm:w-1/5 text-center bg-main text-sec my-4 rounded-xl py-2 font-semibold border hover:bg-transparent hover:border-bg-sec"
                    >
                      Save
                    </button>
                  </Form>
