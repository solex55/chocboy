  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-full w-full ">
      <div className="h-full w-full mx-auto p-4">
        <div className="pb-8">
          <h3 className="text-2xl font-bold text-white py-6 pb-4">
        ...
        <div className="flex gap-4 pb-16">
          <div>
            <img
              src={smiley}
              alt=""
              className="rounded-full shawdow-lg max-w-full border-none align-middle"
            />
          </div>
          <div className="gap-4">
                ...
                <div className=" flex flex-col justify-center">
                  <Form className="max-w-[800px] w-full mx-auto p-4">
                    ...
                    <p className="text-lg text-white pb-4">
                      Got a question about Chocboy? Want to partner with us?
                      Have any suggestions, or just want to say Hi?
                    </p>
                    ...
                    <button
                      ...
                      className="w-full sm:w-1/5 text-center cursor-pointer bg-sec text-main my-4 rounded-xl py-2 font-semibold hover:border hover:bg-transparent hover:text-sec "
                    >
                      Submit
                    </button>
                  </Form>
