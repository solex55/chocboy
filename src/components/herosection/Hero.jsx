    ...
    <div className="relative w-full h-screen ">
      ...
      {/* <div className="flex absolute  herosection   items-center justify-between gap-12 z-30 px-8 md:px-12  py-12 mb-24 text-main flex-col xl:flex-row">
        <div className="flex flex-col gap-4 w-full xl:w-3/5">
          <h1 className="text-4xl lg:text-6xl mb-4 max-w-lg">
            Anytime is <br />
            <span className="text-6xl lg:text-6xl font-bold">
              {" "}
              Chocolate time!
            </span>
          </h1>
          <div className="w-full hero">
            <Link to="/shop">
              <button
                className="px-2 lg:px-4 py-4 w-36 lg:w-72 text-center text-white rounded-md shadow-md text-sm lg:text-xl font-bold"
                style={{
                  background:
