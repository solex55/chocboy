    ...
    <div>
        ...
        <h3 className='font-bold pb-4'>Instructions</h3>
            <ol className="space-y-4 list-decimal">
                ...
                <li>
                    Beat the eggs with the sugar in a bowl, add the softened butter cut into small pieces, next, gradually add the two types of flour, and the yeast mixture.                    
                </li>
                <li>Last, add the salt.</li>
                <li>
                    Knead the ingredients together first in the bowl, then place the dough on a work surface and knead it until it becomes smooth and elastic.
                </li> 
                <li>
                    Place the dough in a warm area to rise until it doubles in size, approximately 2 hours.
                </li>  
                <li>
                    Roll out the dough into a rectangle, 1/2 centimeter in thickness.
                </li>
                <li>
                    Spread a generous amount of Chocboy all over the surface of the dough, then roll up the dough lengthwise into a cylinder, cut the cylinder in half.
                </li>
                <li>
                    Braid the two pieces of dough, fold the ends under the braid, place the braid in a loaf pan lined with wax paper.
                </li>
                <li>
