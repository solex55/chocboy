...
function Abouttext() {
  return (
    <div>
        <div className='text-center mx-16 lg:mx-40 text-sub my-20'>
        ...
        <div className='mx-8 lg:mx-20 mb-16 text-sub'>
        <h3 className='mb-8 font-bold text-3xl text-sub text-center'>Our Story</h3>
