...
function footer() {
  return (
     ...
     */
    <footer
      className="w-full bg-foot h-fit relative mt-16 "
      style={{
        ...
        <div className="footer_content bg-foot  flex flex-col z-3 text-white justify-center items-center">
          ...
          <div className="footer_main  bg-foot flex flex-col text-center px-16 lg:px-24 item-center ">
            <div className="footer_logo">
              <h3 className="text-3xl font-bold  lg:text-4xl pb-4">
                Contact Us
              </h3>
            </div>
            ...
            <div className="footer_sm text-center py-4 lg:py-8 px-4 sm:px-16 text-md">
              ...
              <p className="text-md lg:text-2xl">
                Block A Unit 5 Technology Incubation Centre Beside Oyo State
                Permanent Trade Fair Complex EXPOYO Off Oyo Road Ibadan.
              </p>
            </div>
          </div>
